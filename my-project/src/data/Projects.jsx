const projects = [
  {
    ...
    title: "Shoes Store",
    shortdescription:
      "This project showcases a simple e-commerce website built for buying Nike shoes. Developed using HTML, CSS, and JavaScript, it features a clean and modern design with responsive layout adjustments for mobile and desktop views. The site includes product listings, detailed product information, and interactive features such as a shopping cart simulation. It demonstrates my skills in frontend development and user interface design.",
    description:
  ...
  },
  {
    ...
    shortdescription:
      "This is a user-friendly web application for purchasing various breeds of dogs and cats. Built using PHP, HTML, CSS, and JavaScript, the store offers detailed information about each breed, including their characteristics and prices. Customers can easily browse, select, and buy their favorite pets through an intuitive interface, ensuring a seamless shopping experience. ",
    description:
  ...
  },
  {
    ...
    shortdescription:
      "This is a chat application built with Node.js, React, and Tailwind CSS, allowing users to sign up, log in, and engage in real-time chats. The application is designed with a responsive user interface, ensuring a smooth experience across devices. Using Node.js for the backend, it handles user authentication, real-time message exchange, and session management. React handles the frontend, providing a dynamic and interactive chat interface. Tailwind CSS ensures a sleek, modern design with a focus on usability and responsive design. The application also includes animations for smooth transitions and a seamless user experience.",
    description:
  ...
  },
  {
    ...
    title: "E_shop",
    shortdescription:
      "I have developed a frontend-only e-commerce website where users can browse and shop for products like watches, laptops, and headphones. The website is built using React, Tailwind CSS, and JavaScript, focusing on a responsive and user-friendly design. The homepage showcases product categories with clean, interactive UI elements, while product pages display detailed information. Tailwind CSS is used to create a modern, mobile-responsive layout, ensuring a seamless shopping experience across all devices. Although the website is purely frontend, it is designed to simulate an online shopping experience with a visually appealing and functional interface.",
    description:
  ...
  },
  {
    ...
    title: "Blogs",
    shortdescription:
      "I have developed a simple blogging website using WordPress, where users can explore and read articles on various topics. The website features a clean and minimalistic design, ensuring a smooth and distraction-free reading experience. Built with WordPress, it offers easy content management and customization, making it an efficient platform for sharing blogs. The site is fully responsive, allowing users to access articles seamlessly across different devices.",
    description:
